package btscore.editor.blocksearch;
...
public class BlockSearchController {
    ...
    public BlockSearchController(CommandDispatcher actionManager, CommandFactory commandFactory, EditorEventRouter eventRouter, EditorContext context, BlockSearchView blockSearchView, BlockDefLibrary blockDefLibrary) {
